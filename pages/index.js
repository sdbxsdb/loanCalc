          ...
          <form action="" className="flex flex-col gap-y-10">
            <div className="w-full bg-primary rounded-full pr-4">
              ...
              <div className="flex flex-col gap-y-10">
                ...
                {loanType === "Personal Loan up to £7,500" ? (<input
                  ...
                  value={loanAmount}
                />) : null }
                {loanType === "Personal Loan £7,501 to £15,000" ? (<input
                  onChange={(e) => setLoanAmount(e.target.value)}
                  type="range"
                  name="rangeInput"
                  className="range rounded-lg bg-primary h-[10px] w-full"
                  ...
                  value={loanAmount}
                />) : null }
                {loanType === "Personal Loan £15,000 to £25,000" ? (<input
                  onChange={(e) => setLoanAmount(e.target.value)}
                  type="range"
                  name="rangeInput"
                  className="range rounded-lg bg-primary h-[10px] w-full"
                  ...
                  value={loanAmount}
                />) : null }
                {loanType === "Secured / Share Secured Personal Loan up to £25,000" ? (<input
                  onChange={(e) => setLoanAmount(e.target.value)}
                  type="range"
                  name="rangeInput"
                  className="range rounded-lg bg-primary h-[10px] w-full"
